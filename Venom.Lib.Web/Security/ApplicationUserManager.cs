...
namespace Venom.Web.Security
{
    ...
    public class ApplicationUserManager : UserManager<IdentityUser>
    {
        ...
        /// Default constructor
        /// </summary>
        /// <param name="store">the user store instance</param>
        ...
        /// <summary>
        /// Factory a ApplicationUserManager instance to enjoy the default user manager asp.net provided
        /// </summary>
        /// <param name="options">the options to creation</param>
        /// <param name="context">the current context</param>
        /// <returns>An instance of ApplicationUserManager</returns>
